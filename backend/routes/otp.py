            ...
            with conn.cursor(cursor_factory=RealDictCursor) as cur:
                ...
                cur.execute("""
                    INSERT INTO users (
                        ...
                        phone_number, address, dob, role, 
                        account_status, organization_name, club_id
                    ) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
                    RETURNING id
                """, (full_name, email, reg_no, password_hash, encrypted_phone, encrypted_address, encrypted_dob, role, account_status, raw_org_name, club_id))
