            ...
            with conn.cursor(cursor_factory=RealDictCursor) as cur:
                ...
                cur.execute("""
                    INSERT INTO events (
                        ...
                        team_size, female_mandatory, poster_url, 
    ...
    try:
        with DatabaseConnection() as conn:
            with conn.cursor(cursor_factory=RealDictCursor) as cur:
                ...
                reg_amount = data.get('reg_amount', 0)
                ...
                cur.execute("""
                    UPDATE events 
                    SET title = %s, description = %s, hall_id = %s, team_size = %s, 
                    ...
                    WHERE id = %s
                """, (
                    title, description, hall_id, team_size, female_mandatory,
